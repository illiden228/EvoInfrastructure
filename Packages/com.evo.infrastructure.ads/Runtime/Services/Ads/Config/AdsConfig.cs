...
namespace Evo.Infrastructure.Services.Ads.Config
{
    ...
    public sealed class AdsConfig : ScriptableObject, IGameConfig
    {
        ...
        [Header("Interstitial Cooldown (sec)")]
        [SerializeField] private int interstitialCooldownSeconds = 300;
        ...
        public int InterstitialCooldownSeconds => interstitialCooldownSeconds < 0 ? 0 : interstitialCooldownSeconds;
