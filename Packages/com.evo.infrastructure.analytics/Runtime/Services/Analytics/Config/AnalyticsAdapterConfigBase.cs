...
namespace Evo.Infrastructure.Services.Analytics.Config
{
    ...
    public sealed class AnalyticsExtraParameter
    {
        ...
        public string Key;
        [Tooltip("@Evo.Infrastructure.Editor.EvoTools.EvoToolsLocalization.Get(\"analytics.extra_params.value.tooltip\", \"Value for the parameter key. Add tooltip text to EvoTools localization if needed.\")")]
        public string Value;
    ...
    public abstract class AnalyticsAdapterConfigBase : ScriptableObject
    {
        ...
        [Title("Adapter")]
#endif
        [Tooltip("@Evo.Infrastructure.Editor.EvoTools.EvoToolsLocalization.Get(\"analytics.adapter_id.tooltip\", \"Optional override. Leave empty to use default adapter id from code.\")")]
        [SerializeField] private string adapterId;
        [SerializeField] private string appKey;

#if ODIN_INSPECTOR
        [Title("Extra Parameters")]
        [InfoBox("@Evo.Infrastructure.Editor.EvoTools.EvoToolsLocalization.Get(\"analytics.extra_params.info\", \"Add tooltip text to EvoTools localization table for parameter keys.\")", InfoMessageType.Info)]
