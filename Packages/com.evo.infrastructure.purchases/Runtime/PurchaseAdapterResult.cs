...
{
    public readonly struct PurchaseAdapterResult
    {
        public PurchaseAdapterResult(PurchaseStatus status, PurchaseTransaction transaction = default, string error = null)
        {
            Status = status;
